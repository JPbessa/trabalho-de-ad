...
//		double soma = 0;
		...
		// Estruturas utilizadas no calculo do Número Médio de Colisoes por Quadro
...
//		while (evento != null && evento.getRodada() == rodadaAtual) {
			...
			// Devemos obter as médias dos valores das seguinte medidas
			...
			/*
			 * Vazão
			 * Relação entre o número de quadros transmitidos com sucesso na estação
			 * e o tempo de simulação, desconsiderando a fase transiente.
			 */
...
//		System.out.println("Média rodada: " + mediaRodada);
